...
public class Cafe_details extends AppCompatActivity {
    ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location = findViewById(R.id.cafe_loactionn);
        name = findViewById(R.id.Cafe_name);
        img = findViewById(R.id.imageC);
        com = findViewById(R.id.comCBtn);
        comtext = findViewById(R.id.textcom);
        refsh = findViewById(R.id.refreshC);
        recyclerView = findViewById(R.id.comCrecycler);
        ...
        img.setImageResource(R.drawable.baroque);
        ...
        com.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (comtext.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Cafe_details.this, "Add a comment!", Toast.LENGTH_SHORT).show();
        ...
        compositeDisposable.add(iNodeJS.commenterUser(commentaire, id_user, nom_user)
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(String s) throws Exception {
                        Toast.makeText(Cafe_details.this, "" + s, Toast.LENGTH_SHORT).show();
                    }
                })
        );
