...
import com.example.xbree.Accueil;
...
public class Restau_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com = findViewById(R.id.comBtn);
        comtext = findViewById(R.id.textcom);
        refsh = findViewById(R.id.refresh);
        recyclerView = findViewById(R.id.comrecycler);
        ...
        com.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (comtext.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Restau_details.this, "Add a comment!", Toast.LENGTH_SHORT).show();
        ...
        compositeDisposable.add(iNodeJS.commenterUser(commentaire, id_user, nom_user)
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(String s) throws Exception {
                        Toast.makeText(Restau_details.this, "" + s, Toast.LENGTH_SHORT).show();
                    }
                })
        );
